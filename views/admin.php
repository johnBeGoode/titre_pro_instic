...
<div id="page-admin">
    ...
    <div id="wrapper">
        ...
        <div class="tabs-content">
            <table id="articles" class="admin-articles table table-striped tab-content active">
                <thead>
                    <tr>
                        <th>Image</th>
                        <th>Titre</th>
            ...
            <table id="commentaires" class="admin-comments table table-striped tab-content">
                <thead>
                    <tr>
                        <th>Commentaires</th>
                        <th>Date d'ajout</th>
